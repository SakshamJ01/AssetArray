...
const INITIAL_INSTRUMENTS: Record<string, LiveInstrument> = {
  ...
  "BANKNIFTY": {
    ...
    lastTickDirection: "up",
    lastUpdated: Date.now(),
    tickHistory: [51890, 51950, 52020, 52100, 52140.8],
    depth: {
      bids: [
        { price: 52138.0, quantity: 320, orders: 14 },
        { price: 52135.0, quantity: 750, orders: 28 },
        { price: 52130.0, quantity: 1400, orders: 45 },
        { price: 52120.0, quantity: 2600, orders: 72 },
        { price: 52100.0, quantity: 4800, orders: 110 },
      ],
      asks: [
        { price: 52142.0, quantity: 410, orders: 16 },
        { price: 52145.0, quantity: 890, orders: 31 },
        { price: 52150.0, quantity: 1600, orders: 52 },
        { price: 52160.0, quantity: 2900, orders: 84 },
        { price: 52180.0, quantity: 5200, orders: 130 },
      ],
      totalBidQty: 9870,
      totalAskQty: 11000,
    },
  ...
  "SGB_GOLD": {
    ...
    lastTickDirection: "up",
    lastUpdated: Date.now(),
    tickHistory: [7240, 7250, 7265, 7275, 7280],
    depth: {
      bids: [
        { price: 7278.0, quantity: 450, orders: 8 },
        { price: 7275.0, quantity: 1200, orders: 18 },
        { price: 7270.0, quantity: 2500, orders: 32 },
        { price: 7265.0, quantity: 4100, orders: 55 },
        { price: 7260.0, quantity: 7500, orders: 80 },
      ],
      asks: [
        { price: 7282.0, quantity: 500, orders: 10 },
        { price: 7285.0, quantity: 1400, orders: 22 },
        { price: 7290.0, quantity: 2800, orders: 38 },
        { price: 7295.0, quantity: 4600, orders: 60 },
        { price: 7300.0, quantity: 8200, orders: 95 },
      ],
      totalBidQty: 15750,
      totalAskQty: 17500,
    },
  ...
  "BHARATBOND30": {
    ...
    lastTickDirection: "up",
    lastUpdated: Date.now(),
    tickHistory: [1245.2, 1246.0, 1247.2, 1248.0, 1248.5],
    depth: {
      bids: [
        { price: 1248.2, quantity: 1500, orders: 12 },
        { price: 1248.0, quantity: 3800, orders: 25 },
        { price: 1247.5, quantity: 6500, orders: 42 },
        { price: 1247.0, quantity: 11000, orders: 68 },
        { price: 1246.0, quantity: 18000, orders: 95 },
      ],
      asks: [
        { price: 1248.8, quantity: 1800, orders: 14 },
        { price: 1249.0, quantity: 4200, orders: 28 },
        { price: 1249.5, quantity: 7100, orders: 48 },
        { price: 1250.0, quantity: 12500, orders: 75 },
        { price: 1251.0, quantity: 19500, orders: 110 },
      ],
      totalBidQty: 40800,
      totalAskQty: 45100,
    },
  ...
  "IN_10Y_GSEC": {
    symbol: "IN_10Y_GSEC",
    name: "India 10Y Benchmark Sovereign Yield",
    exchange: "NSE",
    currency: "%",
    price: 6.94,
    previousClose: 6.96,
    ...
    lastTickDirection: "down",
    lastUpdated: Date.now(),
    tickHistory: [6.96, 6.955, 6.95, 6.945, 6.94],
    depth: {
      bids: [
        { price: 6.938, quantity: 50000, orders: 8 },
        { price: 6.935, quantity: 120000, orders: 16 },
        { price: 6.930, quantity: 250000, orders: 28 },
        { price: 6.925, quantity: 450000, orders: 45 },
        { price: 6.920, quantity: 800000, orders: 70 },
      ],
      asks: [
        { price: 6.942, quantity: 60000, orders: 10 },
        { price: 6.945, quantity: 140000, orders: 18 },
        { price: 6.950, quantity: 280000, orders: 32 },
        { price: 6.955, quantity: 500000, orders: 50 },
        { price: 6.960, quantity: 900000, orders: 80 },
      ],
      totalBidQty: 1670000,
      totalAskQty: 1880000,
    },
